...
This folder contains tekton resources used build and release the pr-status-updater custom task. The resources included in `kustomization.yaml` are installed nightly on
